...
namespace InMemoryLoaderCommonTestSuite.ConvertUtilsTest
{
	public partial class Test
	{
		...
		/// The log.
		/// </summary>
		private static readonly ILog log = LogManager.GetLogger (typeof(InMemoryLoaderCommonTestSuite.ConvertUtilsTest.Test));
		/// <summary>
		/// The app base.
		/// </summary>
